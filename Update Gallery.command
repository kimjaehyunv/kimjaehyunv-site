...
echo "  1. Read originals from images/*/originals/ (originals are never modified)"
echo "  2. Generate optimized web JPG files (new/changed only)"
echo "  3. Generate WebP files (new/changed only)"
echo "  4. Build gallery.json files"
echo "  5. git add → git commit → git push origin main"
echo ""
